...
- **Test-driven development** where applicable: 3,288 tests in the suite (26 skipped); full suite runs in ~70 s on bare host.
...
- **2026-05-30**: refreshed for the v0.80.0 submission state — §2.4 algorithm spec corrected to match the implemented four-sub-score scorer; test count (3,288), MCP tool count (15), provider list (incl. Codex CLI), and shipped CI/Nix/accessibility/release status updated.
