...
def main() -> int:
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            # R25.1 — Assistant view removed; chat dock is the only
            # surface. The dock is visible after login at every
            # viewport, so no navigation step is needed.
            page.locator("#dockChatInput").wait_for(state="visible",
                                                       timeout=10000)
            report("dock_chat_visible", True)
