...
- **Reproducible build**: Nix flake at repo root pinning
  ...
  runs the full 3,288-test suite (26 skipped; live count
...
- **Structural verifications carry forward** (16 IQ-Netzwerk
  ...
  MCP catalogue + 15-tool count; 3,288 tests (live 2026-05-30);
...
**Net effect at 2026-05-24** (with a 2026-05-29 refresh): every prior-verified row carries forward; three rows were corrected for staleness on 2026-05-29 — test count (1020/1029 → live **3,288 / 26 skipped**, re-confirmed 2026-05-30), v0.1.0 SBOM component count (91 → **96**, `jq`-derivable), and MCP catalogue tool count (13 → **15**, pinned by test). No new claims introduced since pass 3 require new verification work.
