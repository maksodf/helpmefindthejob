...
Meanwhile, the institutions that serve users facing this friction — Migrationsberatungsstellen (~700 across Germany, migrant-focused by mandate), IQ-Netzwerk's 16 regional networks, the 110 autonomous Optionskommunen Jobcenter (the federally-capped maximum per §6a SGB II + Article 91e(2) Grundgesetz, serving all Bürgergeld recipients of which the migrant population is one significant subset), and university career services (international graduates plus first-generation graduates and career changers) — operate under acute capacity constraints. Advisor time is the bottleneck. Translation services are expensive. AI tooling that could help is gated behind commercial pricing or compliance risk most institutions cannot absorb.
