...
|---|---|---|
| P1 | Site down, login broken, data export blocked, GDPR deletion request | Acknowledge within 4h, resolve within 24h |
...
2. **Is it a bug?** If reproducible, file as a Linear/GitHub issue with `bug` label, link the ticket. Reply with "Confirmed bug, ticket #X" + ETA.
3. **Is it a feature request?** Acknowledge, add to a public-facing roadmap doc (or `docs/roadmap.md`). Don't promise.
