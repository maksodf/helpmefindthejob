    ...
    *, role_text: str, bucket_key: str, years_experience: int | None,
    ...
    fallback_map = {
        ...
        "data_engineer": [
            ...
            "Analytics Engineer", "ML Engineer", "BI Developer",
        ],
        "product_manager": [
        ...
        "designer": [
            ...
            "UI Designer", "Visual Designer", "Design Lead",
        ],
        "marketing": [
            "Growth Marketing Manager", "Content Strategist",
            "Brand Manager", "SEO Specialist", "Performance Marketer",
        ],
        "sales": [
            "Account Executive", "Sales Manager",
            "Business Development Manager", "SDR / BDR",
            "Customer Success Manager",
        ],
        "finance": [
            "Senior Financial Analyst", "Controller",
            "FP&A Manager", "Tax Manager", "Internal Auditor",
        ],
        "consulting": [
            "Senior Consultant", "Strategy Consultant",
            "Management Consultant", "Associate Consultant",
            "Principal Consultant",
        ],
        "customer_success": [
            "Senior Customer Success Manager", "Support Engineer",
            "Client Onboarding Specialist", "Technical Account Manager",
        ],
        "healthcare_management": [
            "Clinical Project Manager", "Healthcare PM",
            "Pflegedienstleitung", "Klinikmanager:in",
